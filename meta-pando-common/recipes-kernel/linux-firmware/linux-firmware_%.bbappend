...
FILES:${PN}-rtl8188eu = " \
    ${libdir}/firmware/rtlwifi/rtl8188eu*.bin* \
    "

PACKAGES =+ "${PN}-iwlwifi-9260"

FILES:${PN}-iwlwifi-9260 = " \
    ${libdir}/firmware/iwlwifi-9260-* \
    "

PACKAGES =+ "${PN}-iwlwifi-qu-b0-hr-b0"

FILES:${PN}-iwlwifi-qu-b0-hr-b0 = " \
    ${libdir}/firmware/iwlwifi-Qu-b0-hr-b0-* \
    "

PACKAGES =+ "${PN}-ibt-19-0-4"

FILES:${PN}-ibt-19-0-4  = " \
    ${libdir}/firmware/intel/ibt-19-0-4.doc* \
    ${libdir}/firmware/intel/ibt-19-0-4.sfi* \
    "

PACKAGES =+ "${PN}-ath10k-qca6174"

FILES:${PN}-ath10k-qca6174 = " \
    ${libdir}/firmware/ath10k/QCA6174/* \
"

PACKAGES =+ "${PN}-rtl8723b-bt"

FILES:${PN}-rtl8723b-bt = " \
    ${libdir}/firmware/rtl_bt/rtl8723b_fw.bin* \
"

PACKAGES =+ "${PN}-iwlwifi-3168"

FILES:${PN}-iwlwifi-3168 = " \
    ${libdir}/firmware/iwlwifi-3168-* \
"

PACKAGES =+ "${PN}-ibt-18-16-1"

FILES:${PN}-ibt-18-16-1  = " \
    ${libdir}/firmware/intel/ibt-18-16-1.sfi* \
    ${libdir}/firmware/intel/ibt-18-16-1.ddc* \
"

PACKAGES =+ "${PN}-ibt-41-41"

FILES:${PN}-ibt-41-41  = " \
    ${libdir}/firmware/intel/ibt-0041-0041.ddc \
    ${libdir}/firmware/intel/ibt-0041-0041.sfi \
"
...
FILES:${PN}-ralink-nic = " \
    ${libdir}/firmware/rtl_nic/rtl8168g-2.fw* \
"

PACKAGES =+ "${PN}-iwlwifi-3160"

FILES:${PN}-iwlwifi-3160 = " \
    ${libdir}/firmware/iwlwifi-3160-17.ucode* \
"

PACKAGES =+ "${PN}-iwlwifi-cc-a0"

FILES:${PN}-iwlwifi-cc-a0 = " \
    ${libdir}/firmware/iwlwifi-cc-a0-*.ucode* \
"

PACKAGES =+ "${PN}-iwlwifi-ty-a0"

FILES:${PN}-iwlwifi-ty-a0  = " \
    ${libdir}/firmware/iwlwifi-ty-a0-*.ucode \
    ${libdir}/firmware/iwlwifi-ty-a0-*.pnvm \
"
