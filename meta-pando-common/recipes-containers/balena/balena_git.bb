...
SRCREV = "0bfcf8cda607bdc23f68e31c25bdaa793ce651c7"
...
SRC_URI = "\
	git://github.com/uinta-labs/balena-engine.git;branch=${BALENA_BRANCH};destsuffix=git/src/import;protocol=https \
	file://balena.service \
...
RDEPENDS:${PN}:class-target = "curl util-linux iptables tini systemd healthdog bash procps-ps ca-certificates"
