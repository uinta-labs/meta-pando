...
do_install:append() {
    ...
    install -m 0755 ${WORKDIR}/pandodataexpander ${D}/init.d/88-pandodataexpander
...
PACKAGES:append = " \
    ...
    initramfs-module-pandodataexpander \
...
SUMMARY:initramfs-module-pandodataexpander = "Expand the data partition to the end of device"
RDEPENDS:initramfs-module-pandodataexpander = "${PN}-base initramfs-module-udev busybox parted util-linux-lsblk e2fsprogs-resize2fs os-helpers-fs"
FILES:initramfs-module-pandodataexpander = "/init.d/88-pandodataexpander"
...
RDEPENDS:initramfs-module-cryptsetup = "${PN}-base cryptsetup libgcc lvm2-udevrules os-helpers-logging os-helpers-fs pando-config-vars-config"
