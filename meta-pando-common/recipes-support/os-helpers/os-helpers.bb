...
do_install() {
    ...
    install -m 0775 \
        ...
        ${WORKDIR}/safe_reboot \
        ${D}${libexecdir}
        sed -i "s,@@PANDO_CONF_UNIT_STORE@@,${PANDO_CONF_UNIT_STORE},g" ${D}${libexecdir}/os-helpers-config
        sed -i -e "s,@@PANDO_FINGERPRINT_FILENAME@@,${PANDO_FINGERPRINT_FILENAME},g" -e "s,@@PANDO_FINGERPRINT_EXT@@,${PANDO_FINGERPRINT_EXT},g" ${D}${libexecdir}/os-helpers-fs
}
...
do_test_api() {
    ...
    endpoint="https://api.${PANDO_API_ENV}"
